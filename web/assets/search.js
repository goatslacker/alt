...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altSearchDocs = __webpack_require__(2);

	var _altSearchDocs2 = _interopRequireDefault(_altSearchDocs);

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var github = /goatslacker.github.io\/alt/;

	if (github.test(location.href)) {
	  location.href = location.href.replace(github, 'alt.js.org');
	}

	_react2['default'].render(_react2['default'].createElement(_altSearchDocs2['default'], { url: '/assets/search.json' }), document.getElementById('alt-search-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSearchView = __webpack_require__(4);

	var _componentsSearchView2 = _interopRequireDefault(_componentsSearchView);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(_componentsSearchView2['default'], { url: this.props.url });
	    }
	  }]);
	...
	if (typeof window !== 'undefined') {
	  window.AltSearchTest = function () {
	    _react2['default'].render(_react2['default'].createElement(App, { url: 'assets/search.json' }), document.getElementById('alt-search-app'));
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altAltContainer = __webpack_require__(35);

	var _altAltContainer2 = _interopRequireDefault(_altAltContainer);

	var _storesSearchStore = __webpack_require__(9);

	var _storesSearchStore2 = _interopRequireDefault(_storesSearchStore);

	var _storesResultsStore = __webpack_require__(10);

	var _storesResultsStore2 = _interopRequireDefault(_storesResultsStore);

	var _SearchBox = __webpack_require__(11);

	var _SearchBox2 = _interopRequireDefault(_SearchBox);

	var _SearchResults = __webpack_require__(12);
	...
	var SearchView = (function (_React$Component) {
	  ...
	  _createClass(SearchView, [{
	    ...
	    value: function componentDidMount() {
	      _storesSearchStore2['default'].loadIndex(this.props.url);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          { store: _storesResultsStore2['default'] },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../css-loader/index.js!./search.css", function() {
				var newContent = require("!!./../../css-loader/index.js!./search.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".alt-search__input {\n  border: 1px solid #cacaca;\n  border-radius: 4px;\n  font-size: 16px;\n  left: 45px;\n  outline: none;\n  position: relative;\n  top: 11px;\n}\n\n.alt-search__results {\n  background: #fff;\n  left: 0;\n  position: absolute;\n  top: 58px;\n  width: 100%;\n  z-index: 1;\n}\n\n.alt-search__result {\n  padding: 1em;\n}\n\n.alt-search__result.selected {\n  background: #e0e0e0;\n}\n\n.alt-search__result-title {\n  font-size: 1em;\n  line-height: 1em;\n  margin-bottom: 0.25em;\n  margin: 0;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n\n.alt-search__result-title mark { }\n\n.alt-search__result-snippet {\n  color: #666;\n  font-size: 0.8em;\n  line-height: 1.15em;\n  margin-bottom: 0.25em;\n  margin: 0;\n}\n\n.alt-search__result-snippet mark {\n  background: inherit;\n  color: #666;\n  font-weight: bold;\n}\n\n.alt-search__result-link {\n  color: #888;\n  font-size: 0.65em;\n  font-weight: normal;\n  margin: 0;\n}\n\nhr {\n  background: #efefef;\n  border: none;\n  height: 1px;\n  margin: 0.5em 0;\n  width: 100%;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    */
	    ...
	    if ("function" === 'function' && __webpack_require__(109)['amd']) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37), __webpack_require__(108).setImmediate, (function() { return this; }()), __webpack_require__(110)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lunr = __webpack_require__(113);
	...
	var _altUtilsDecorators = __webpack_require__(39);

	var _sourcesSearchSource = __webpack_require__(40);

	var _sourcesSearchSource2 = _interopRequireDefault(_sourcesSearchSource);

	var _actionsSearchActions = __webpack_require__(41);

	var _actionsSearchActions2 = _interopRequireDefault(_actionsSearchActions);

	var _utilsMarked = __webpack_require__(42);

	var _utilsMarked2 = _interopRequireDefault(_utilsMarked);

	var SearchStore = (function () {
	  function SearchStore() {
	    _classCallCheck(this, _SearchStore);
	  ...
	  _createDecoratedClass(_SearchStore, [{
	    key: 'receivedIndex',
	    decorators: [(0, _altUtilsDecorators.bind)(_actionsSearchActions2['default'].receivedIndex)],
	    value: function receivedIndex(json) {
	      this.documents = json.docs.reduce(function (obj, doc) {
	        obj[doc.id] = doc;
	        doc.tokens = _utilsMarked2['default'].lexer(doc.body).filter(function (tokens) {
	          return tokens.type === 'paragraph';
	        });
	        return obj;
	      }, {});
	      this.index = _lunr2['default'].Index.load(json.index);
	    }
	  }, {
	    key: 'failedLoadingIndex',
	    decorators: [(0, _altUtilsDecorators.bind)(_actionsSearchActions2['default'].noIndexFound)],
	    value: function failedLoadingIndex(err) {
	      this.index = null;
	      console.error(err);
	    }
	  }], [{
	  ...
	  SearchStore = (0, _altUtilsDecorators.datasource)(_sourcesSearchSource2['default'])(SearchStore) || SearchStore;
	  SearchStore = (0, _altUtilsDecorators.decorate)(_alt2['default'])(SearchStore) || SearchStore;
	  return SearchStore;
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStringScore = __webpack_require__(43);

	var _utilsStringScore2 = _interopRequireDefault(_utilsStringScore);

	var MAX_CHAR_SUMMARY = 240;

	var ResultsStore = (function () {
	  function ResultsStore() {
	    _classCallCheck(this, _ResultsStore);

	    this.searchTerm = '';
	    this.results = [];
	  }

	  var _ResultsStore = ResultsStore;

	  _createDecoratedClass(_ResultsStore, [{
	    key: 'search',
	    decorators: [(0, _altUtilsDecorators.bind)(_actionsSearchActions2['default'].search)],
	    ...
	    key: 'select',
	    decorators: [(0, _altUtilsDecorators.bind)(_actionsSearchActions2['default'].select)],
	    value: function select(dir) {
	      ...
	      for (var i = 0; i < length; i += 1) {
	        ...
	        if (selected) {
	          if (dir === 'down') {
	            var selectIndex = i < length - 1 ? i + 1 : 0;
	            return this.results[selectIndex].selected = true;
	          } else {
	            var selectIndex = i > 0 ? i - 1 : length - 1;
	            return this.results[selectIndex].selected = true;
	          }
	        }
	      }
	    ...
	    key: 'followSelected',
	    decorators: [(0, _altUtilsDecorators.bind)(_actionsSearchActions2['default'].go)],
	    value: function followSelected() {
	      var result = this.results.filter(function (x) {
	        return x.selected;
	      })[0] || this.results[0];
	    ...
	    key: 'getSnippet',
	    value: function getSnippet(tokens) {
	      var text = this.searchTerm;
	      var items = tokens.map(function (token) {
	        return {
	          score: (0, _utilsStringScore2['default'])(token.text, text),
	          text: token.text
	        };
	      }).filter(function (obj) {
	        return obj.score > 0;
	    ...
	    value: function doSearch(text) {
	      ...
	      var _SearchStore$getState = _storesSearchStore2['default'].getState();

	      var index = _SearchStore$getState.index;
	      var documents = _SearchStore$getState.documents;

	      // Search and return the top 10 documents
	      return index.search(text).map(function (result) {
	        var doc = documents[result.ref];
	        doc.snippet = _this.getSnippet(doc.tokens);
	        doc.selected = false;
	        return doc;
	      }).slice(0, 10);
	    }
	  ...
	  ResultsStore = (0, _altUtilsDecorators.decorate)(_alt2['default'])(ResultsStore) || ResultsStore;
	  return ResultsStore;
	})();

	exports['default'] = _alt2['default'].createStore(ResultsStore);
	module.exports = exports['default'];
	...
	var SearchBox = (function (_React$Component) {
	  ...
	  _createClass(SearchBox, [{
	    ...
	    value: function componentDidUpdate() {
	      _actionsSearchActions2['default'].search(this.state.value);
	    }
	  }, {
	    key: 'parseKeyCode',
	    value: function parseKeyCode(ev) {
	      var keyCode = ev.keyCode;

	      if (keyCode === 38 || keyCode === 40 || keyCode === 13) {
	        ev.preventDefault();
	        if (keyCode === 13) {
	          _actionsSearchActions2['default'].go();
	        } else {
	          _actionsSearchActions2['default'].select(keyCode === 40 ? 'down' : 'up');
	        }
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('input', {
	        ...
	        onKeyDown: function (ev) {
	          return _this.parseKeyCode(ev);
	        },
	        onChange: function (ev) {
	          return _this.setState({ value: ev.target.value });
	        }
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactTextHighlight = __webpack_require__(114);

	var _reactTextHighlight2 = _interopRequireDefault(_reactTextHighlight);
	      ...
	      return _react2['default'].createElement(
	        ...
	        this.props.results.map(function (result, i) {
	          ...
	          return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'h3',
	              { className: 'alt-search__result-title' },
	              _react2['default'].createElement(
	                'a',
	                { href: result.permalink },
	                _react2['default'].createElement(_reactTextHighlight2['default'], {
	                  highlight: _this.props.searchTerm,
	            ...
	            _react2['default'].createElement(
	              'p',
	              { className: 'alt-search__result-snippet' },
	              _react2['default'].createElement(_reactTextHighlight2['default'], {
	                highlight: _this.props.searchTerm,
	                text: result.snippet
	              })
	            ...
	            _react2['default'].createElement(
	              'h5',
	              { className: 'alt-search__result-link' },
	              result.permalink
	            )
	          );
	        })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altUtilsChromeDebug = __webpack_require__(115);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _functions = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  loadIndex: function loadIndex(url) {
	    return {
	      remote: function remote(state, url) {
	        return _axios2['default'].get(url).then(function (req) {
	          return req.data;
	        });
	      },

	      success: _actionsSearchActions2['default'].receivedIndex,
	      error: _actionsSearchActions2['default'].noIndexFound
	    };
	  }
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchActions = (function () {
	  function SearchActions() {
	    ...
	    this.generateActions('go', 'noIndexFound', 'receivedIndex', 'search', 'select');
	  }

	  _createClass(SearchActions, null, [{
	    key: 'displayName',
	    value: 'SearchActions',
	    enumerable: true
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(setImmediate, clearImmediate) {var nextTick = __webpack_require__(167).nextTick;
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(108).setImmediate, __webpack_require__(108).clearImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mixinContainer = __webpack_require__(162)
	var assign = __webpack_require__(116).assign
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextHighlight = (function (_React$Component) {
	  ...
	  _inherits(TextHighlight, _React$Component);
	  ...
	  _createClass(TextHighlight, [{
	    ...
	    value: function updateDOM() {
	      ...
	      el.innerHTML = this.mark(this.props.highlight, this.props.text, this.props.markTag, this.props.caseSensitive);
	    }
	  }, {
	    key: 'mark',
	    value: function mark(val, str, markTag, caseSensitive) {
	      val = val || '';
	      ...
	      return str.replace(RegExp(escape, caseSensitive ? 'g' : 'gi'), tagStr.replace(/{tag}/gi, markTag));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('span', { className: 'TextHighlight', ref: 'text' });
	    }
	  }]);
	...
	TextHighlight.propTypes = {
	  highlight: _react2['default'].PropTypes.string.isRequired,
	  text: _react2['default'].PropTypes.string.isRequired,
	  markTag: _react2['default'].PropTypes.string,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flux = __webpack_require__(193);

	var _utilsStateFunctions = __webpack_require__(185);

	var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

	var _symbolsSymbols = __webpack_require__(186);

	var Sym = _interopRequireWildcard(_symbolsSymbols);

	var _utilsFunctions = __webpack_require__(116);
	...
	var _utilsAltUtils = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(36)();
	exports.push([module.id, "/* styling not present on IE9 */\nmark {\n  background: #ff0;\n  color: #000;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _esSymbol = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventemitter3 = __webpack_require__(217);
	...
	var _AltStore = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(204);
	var ReactFragment = __webpack_require__(47);
	var ReactTransitionGroup = __webpack_require__(205);
	var ReactUpdates = __webpack_require__(99);

	var cx = __webpack_require__(206);
	var cloneWithProps = __webpack_require__(207);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(209);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict'
	var Symbol = __webpack_require__(218)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(19);
	var ReactPropTransferer = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(30);
	var emptyFunction = __webpack_require__(105);
	var joinClasses = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var urlIsSameOrigin = __webpack_require__(235);
